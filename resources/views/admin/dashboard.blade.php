...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-5">
    ...
    <div class="stat-card">
        <div class="flex items-center justify-between mb-3">
            ...
            <div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="background:var(--blue-50);">
    ...
    <div class="stat-card">
        <div class="flex items-center justify-between mb-3">
            ...
            <div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="background:var(--green-50);">
    ...
    <div class="stat-card">
        <div class="flex items-center justify-between mb-3">
            ...
            <div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="background:var(--orange-50);">
    ...
    <div class="stat-card">
        <div class="flex items-center justify-between mb-3">
            ...
            <div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="background:#faf5ff;">
...
<div class="grid grid-cols-3 gap-3 md:gap-4 mb-5">
    ...
    <div class="card card-p flex items-center gap-3">
        <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style="background:var(--yellow-50);">
...
<div class="alert alert-warning mb-5">
    ...
    <span>
        <strong>{{ $pendingPaymentCount }} pembayaran</strong> menunggu verifikasi.
        <a href="{{ route('admin.orders.index', ['payment_status' => 'uploaded']) }}" style="color:var(--yellow-700);font-weight:700;text-decoration:underline;">
            Verifikasi sekarang →
        </a>
    </span>
</div>
...
<div class="grid lg:grid-cols-2 gap-4">
    ...
    <div class="card card-p">
        ...
        <div class="flex items-center gap-3 mb-3">
            <span class="badge {{ $badgeMap[$color] ?? 'badge-gray' }} flex-shrink-0" style="min-width:140px;justify-content:center;">
                {{ $label }}
            </span>
    ...
    <div class="card card-p">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('admin.orders.index') }}" class="text-xs font-semibold" style="color:var(--orange-500);">
                Lihat semua →
            </a>
        </div>
        ...
        <a href="{{ route('admin.orders.show', $o->id) }}"
           ...
           style="border-bottom:1px solid var(--border);">
            <div class="min-w-0">
                ...
                <p class="text-xs text-gray-400">{{ $o->created_at->diffForHumans() }} &middot; #{{ $o->id }}</p>
            </div>
